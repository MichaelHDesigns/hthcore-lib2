...
We're working hard to make _hthcore-lib_ the most powerful JavaScript library for working with Dash. Our goal is to have _hthcore-lib_ be a library that can be used by anyone interested in Dash, and to level expertise differences with great design and documentation.
...
#### T3 - Require 'hthcore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the hthcore object.

DO:

```javascript
var hthcore = require('../');
var PublicKey = hthcore.PublicKey;
```
