...
var HDPrivateKey = hthcore.HDPrivateKey;
var HDPublicKey = hthcore.HDPublicKey;
...
describe('BIP32 compliance', function () {
  ...
  describe('edge cases', function () {
    ...
    it('will handle edge case that derived private key is invalid', function () {
      ...
      var unstubbed = hthcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox
        .stub(hthcore.crypto.BN.prototype, 'toBuffer')
      ...
      sandbox.spy(hthcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      hthcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function () {
      ...
      var unstubbed = hthcore.PublicKey.fromPoint;
      hthcore.PublicKey.fromPoint = function () {
        hthcore.PublicKey.fromPoint = unstubbed;
