...
const hthcore = require('../../index');
const SimplifiedMNListStore = require('../../lib/deterministicmnlist/SimplifiedMNListStore');
const InstantLock = hthcore.InstantLock;
const QuorumEntry = hthcore.QuorumEntry;
...
const hthcoreLib = require('../../index');
...
describe('InstantLock', function () {
  ...
  beforeEach(() => {
    hthcoreLib.Networks.enableRegtest();
