...
var BufferWriter = hthcore.encoding.BufferWriter;
var BufferReader = hthcore.encoding.BufferReader;
...
describe('Output', function () {
  ...
  it('#toObject roundtrip will handle an invalid (null) script', function () {
    ...
    var br = new hthcore.encoding.BufferReader(invalidOutputScript);
