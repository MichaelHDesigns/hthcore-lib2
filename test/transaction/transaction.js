...
var Input = hthcore.Transaction.Input;
var Output = hthcore.Transaction.Output;
var PrivateKey = hthcore.PrivateKey;
var Script = hthcore.Script;
var Address = hthcore.Address;
var Opcode = hthcore.Opcode;
var errors = hthcore.errors;
var Payload = hthcore.Transaction.Payload;
...
describe('Transaction', function () {
  ...
  it('fromObject with pay-to-public-key previous outputs', function () {
    ...
    tx.inputs[0].should.be.instanceof(hthcore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function () {
    ...
    it('will add an empty script if not supplied', function () {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(hthcore.Script);
  ...
  describe('fromObject', function () {
    it('Should copy transaction when passing instance of Transaction as arg', function () {
      ...
      var copiedTransaction = hthcore.Transaction().fromObject(tx);
      expect(copiedTransaction).to.be.an.instanceof(hthcore.Transaction);
    });
  });
